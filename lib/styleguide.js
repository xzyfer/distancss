var Styleguide, sectionQueryMatch;

/**
 * An instance of this class is returned on finishing `distancss.traverse`.
 * Exposes convenience methods for interpreting data.
 *
 * @param {Object} data The data object generated by traverse.
 */
module.exports = Styleguide = function (data) {
    if (!(this instanceof Styleguide)) {
...
Styleguide.prototype.section = function(query) {
